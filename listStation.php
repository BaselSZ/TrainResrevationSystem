...
<body>
    <div class="login-container">
        ...
        <section class="login-form">
            <h2 id="form-title">view Stations</h2>
            <?php
            ...
            if(strpos($fullUrl, "success")==true){
                ...
                foreach ($_SESSION["Stations"] as $station) {
                    ...
                    echo $station['StationName'] . "<br>"; // Echo each station name
                    echo "</h2>";
                 ...
                 ?>
            <form id="myForm" action="includes/listStation.inc.php" method="POST">
                
                <div class="input-field">
                <label for="text" id="password-label">enter TrainID</label>
                <input type="text" id="text" name="TrainID" placeholder="Enter TrainID " required>
                </div>
