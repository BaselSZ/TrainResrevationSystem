...
<body>
    <div class="login-container">
        ...
        <section class="login-form">
            <h2 id="form-title">Add reservation</h2>
            <?php
            $fullUrl ="http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
            if(strpos($fullUrl, "success")==true){
                echo "<h1 style='color:green'>added succefully</h1>";}
                else if(strpos($fullUrl, "failed")==true){
                    echo "<h1 style='color:red'>key constraint violation-not added</h1>";
                }
                 ?>
            <form id="myForm" action="includes/addRes.inc.php" method="POST">
